...
void Section1::execute()
{
    ...
    */
    ...
    switch(state) {
        case 0://直線１
            mLineTrace->setParameter(45, 0.1, 0, 5);//0.07, 0, 1.5,P,I,D
            mDistance->start();
            state = 10;
            break;
        ...
        case 10://カーブ１
            ...
            if(mDistance->getDistance() > 265){
                mLineTrace->setParameter(20, 0.4, 0, 3);// 0.43, 0, 3 //0.58, 0, 4
                mDistance->start();
                state = 15;
                //state = 100;
            }
        ...
        case 15://直線２
            ...
            if(mDistance->getDistance() > 80){
                mLineTrace->setParameter(45,0.1,0,5);
                mDistance->start();
                state = 20; 
                //state = 100;
            }
        ...
        if(mDistance->getDistance() > 135){
            mLineTrace->setParameter(20, 0.5, 0, 3);//30,0.4,0,2.5
            mDistance->start();
            state = 25;
            //state = 100;
        }
