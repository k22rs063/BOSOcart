...
{
    ev3_memfile_load("ev3rt/res/zunda_blue.wav", &memfile_blue);
    ev3_speaker_set_volume(5); //音量の設定
}

void BGMControl::set_greenBGM()
{
    ev3_memfile_load("ev3rt/res/zunda_green.wav", &memfile_green);
    ev3_speaker_set_volume(15); //音量の設定
}

void BGMControl::set_redBGM()
{
    ev3_memfile_load("ev3rt/res/zunda_red.wav", &memfile_red);
    ev3_speaker_set_volume(15); //音量の設定
}

void BGMControl::set_yellowBGM()
{
    ev3_memfile_load("ev3rt/res/zunda_yellow.wav", &memfile_yellow);
    ev3_speaker_set_volume(15); //音量の設定
}

void BGMControl::set_purpleBGM()
{
    ev3_memfile_load("ev3rt/res/zunda_purple.wav", &memfile_purple);
    ev3_speaker_set_volume(15); //音量の設定
}
